...
package{
	...
	public class Test {
		...
		public function Test(){
			...
			// Left
			wallBd.position.Set( -95 / m_physScale, h / m_physScale / 2);
			wall.SetAsBox(100/m_physScale, 400/m_physScale/2);
			wallB = m_world.CreateBody(wallBd);
			wallB.CreateFixture2(wall);
			// Right
			wallBd.position.Set((w + 95) / m_physScale, h / m_physScale / 2);
			wallB = m_world.CreateBody(wallBd);
			wallB.CreateFixture2(wall);
			// Top
			wallBd.position.Set(w / m_physScale / 2, -95 / m_physScale);
			wall.SetAsBox(680/m_physScale/2, 100/m_physScale);
			wallB = m_world.CreateBody(wallBd);
			wallB.CreateFixture2(wall);
			// Bottom
			wallBd.position.Set(w / m_physScale / 2, (h + 95) / m_physScale);
			wallB = m_world.CreateBody(wallBd);
			wallB.CreateFixture2(wall);
		}
		...
		public function GetBodyAtMouse(includeStatic:Boolean = false):b2Body {
			...
			function GetBodyCallback(fixture:b2Fixture):Boolean
			{
				...
				var type:int = fixture.GetBody().GetType();
				if ((type != b2Body.b2_staticBody && type != b2Body.b2_kinematicBody) || includeStatic)
				{
